            ...
            if any(df.empty for df in pivot_source_dfs.values()):
                ...
                if available_efficiency_fields:
                    ...
                    st.caption(
                        ...
                        + (
                            f" Uses your first Values column, `{pivot_value_cols[0]}`."
                    ...
                    # summing the raw values would be. Not offered otherwise, to
                    # avoid silently producing a meaningless number.
                    if pivot_col_cols and normalize_field in pivot_col_cols:
                ...
                with dl_col1:
                    ...
                    if len(pivot_value_cols) > 1:
                        st.caption(f"Flat CSV reflects your first Values column, `{pivot_value_cols[0]}`, only.")
                with dl_col2:
